...
import { PlusCircle, BookOpen, Code, Calculator, AtomIcon, Globe } from 'lucide-react';
...
function App() {
  ...
  const [sections, setSections] = useState<Section[]>([
    ...
    },
    {
      ...
      description: 'Test your knowledge of world affairs and general topics',
      icon: 'Globe',
      questions: generalKnowledgeQuestions,
      lectures: [
        {
          id: 'gk-lec1',
          title: 'Lecture 1: World Geography & History',
          questions: generalKnowledgeQuestions.slice(0, 2)
        },
        {
          id: 'gk-lec2',
          title: 'Lecture 2: Arts & Sciences',
          questions: generalKnowledgeQuestions.slice(2)
        }
      ]
    }
  ]);
    ...
    <div className="min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto">
        <header className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">QuizMaster</h1>
